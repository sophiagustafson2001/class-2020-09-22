...
* Define what we want to know: classes with a high negative enrollment percentage change between the beginning of the semester and now 
* We want to define parallells between classes that all share that negative change characteristic
*Where in the time did most of the students that dropped out drop out 

After we have a model, Temperance suggests we should:
* Admit the limits of models and try to rectify them 
* One limit is that the reasons for dropping the class are not listed so we may not see a clear trend of WHY students dropped out. We also do not have course enrollment data for every day of the week so we may not be able to draw a linear time plot 
